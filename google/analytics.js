...
// Import all autotrack plugins
import 'autotrack/autotrack';
// OR
// Import the individual autotrack plugins you want to use.
// NOTE: UglifyJS throws an unexpected token error when including the individual plugins
//       Need to debug.
 ...
 */
const TRACKING_ID = process.env.analytics.google.id;
 ...
 */
const TRACKING_VERSION = process.env.analytics.google.version;


const TRACK_ERRORS = process.env.analytics.google.trackErrors;
...
const trackError = (error, fieldsObj = {}) => {
  // TODO: use error.name + error.message if error.stack is not available
  ga('send', 'event', {
    ...{
